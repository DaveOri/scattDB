...
for i in fileC.index:
    data.loc[i] = fileC.loc[i,'Dmax'],1.0e-6*fileC.loc[i,'coH'],1.0e-6*fileKu.loc[i,'coH'],1.0e-6*fileKa.loc[i,'coH'],1.0e-6*fileW.loc[i,'coH'],fileKa.loc[i,'crosspol']/fileKa.loc[i,'coH'],1.0e-6*fileKa.loc[i,'crosspol'],np.nan
